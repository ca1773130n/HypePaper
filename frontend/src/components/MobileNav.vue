<template>
  ...
  <Transition name="slide">
    ...
    >
      ...
      <!-- Drawer -->
      <div
        class="absolute top-0 right-0 h-full w-20 bg-white/5 backdrop-blur-xl border-l border-white/20 shadow-2xl"
        @click.stop
      >
        ...
        <div class="flex items-center justify-center p-4 border-b border-white/10">
          ...
          >
            <svg
              class="w-5 h-5 text-gray-200 hover:text-white"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        <nav class="flex flex-col items-center py-6 space-y-6">
          ...
          <button
            ...
            title="Home"
          >
            <svg class="w-7 h-7 text-gray-200 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <template v-if="authStore.isAuthenticated">
            <button
              ...
              title="Profile"
            >
              <svg class="w-7 h-7 text-gray-200 group-hover:text-purple-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              title="Crawl Papers"
            >
              <svg class="w-7 h-7 text-gray-200 group-hover:text-green-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              <svg
                v-if="isSyncing"
                class="animate-spin w-7 h-7 text-orange-400"
                fill="none"
                viewBox="0 0 24 24"
              >
              ...
              <svg v-else class="w-7 h-7 text-gray-200 group-hover:text-orange-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
              </svg>
            </button>

            <div class="w-full px-4 py-3 border-t border-white/10"></div>
            ...
            <button
              ...
              title="Sign Out"
            >
              <svg class="w-7 h-7 text-gray-200 group-hover:text-red-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
